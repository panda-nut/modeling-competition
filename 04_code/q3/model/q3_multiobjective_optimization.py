...
\\begin{{figure}}[H]\\centering\\includegraphics[width=.94\\linewidth]{{../../05_figures/q3/fig_q3_01_pareto_front.pdf}}\\caption{{全局Pareto前沿及两两投影}}\\end{{figure}}
\\begin{{figure}}[H]\\centering\\includegraphics[width=.86\\linewidth]{{../../05_figures/q3/fig_q3_02_candidate_comparison.pdf}}\\caption{{候选方案的统一归一化比较}}\\end{{figure}}
\\begin{{figure}}[H]\\centering\\includegraphics[width=.68\\linewidth]{{../../05_figures/q3/fig_q3_03_design_slice.pdf}}\\caption{{综合最优点所在排数层的局部评分}}\\end{{figure}}
