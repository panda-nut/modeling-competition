...
\usepackage{siunitx}
\graphicspath{{../output/question1/figures/}{../output/question3/figures/}{../output/question45/figures/}}
...
\includegraphics[width=.96\textwidth]{main_effects_cn.pdf}
...
\begin{figure}[H]\centering
\includegraphics[width=.82\textwidth]{anova_contributions.pdf}
...
\begin{figure}[H]\centering
\includegraphics[width=.95\textwidth]{q3_pareto_combined.pdf}
...
\begin{figure}[H]\centering
\includegraphics[width=.88\textwidth]{q4_weight_mapping.pdf}
\caption{权重到最优结构的映射。}
\end{figure}
