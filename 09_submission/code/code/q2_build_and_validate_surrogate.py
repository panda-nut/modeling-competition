...
INPUT = RESULTS / "q1" / "data" / "q1_response_data.csv"
PARETO = RESULTS / "q3" / "data" / "q3_pareto_global.csv"
OUTPUT = RESULTS / "q2" / "data"
RESPONSES = ("R", "P", "U")
DEGREES = (2, 3, 4)
...
def baseline_interpolation_comparison(base: pd.DataFrame) -> pd.DataFrame:
...
def main() -> None:
    ...
    baseline = baseline_interpolation_comparison(base)
    outputs = {
        OUTPUT / "q2_nested_cv_folds.csv": folds,
        OUTPUT / "q2_nested_model_comparison.csv": summary,
        OUTPUT / "q2_alpha_stability.csv": alpha,
        OUTPUT / "q2_baseline_interpolation_comparison.csv": baseline,
    }
