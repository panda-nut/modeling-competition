"""Q1 的 [B] 平行效应分析：主效应、交互效应和描述性平方和分解。"""
...
OUTPUT = ROOT / "03_data" / "processed" / "q1"
FACTORS = ("a", "b", "N")
RESPONSES = ("R", "P", "U")
...
def main() -> None:
    ...
    outputs = {
        OUTPUT / "q1_main_effects_b.csv": main_effects(pin),
        OUTPUT / "q1_interaction_effects_b.csv": interaction_effects(pin),
        OUTPUT / "q1_effect_contributions_b.csv": effect_contributions(pin),
    }
