...
INPUT = ROOT / "03_data" / "processed" / "q3" / "q3_pareto_reference_merged.csv"
OUTPUT = ROOT / "03_data" / "processed" / "q4"
...
def main() -> None:
    ...
    outputs = {
        OUTPUT / "q4_weight_domain_comparison_b.csv": summaries[summaries.regret_definition == "absolute"].copy(),
        OUTPUT / "q4_regret_definition_comparison_b.csv": summaries,
        OUTPUT / "q4_weight_mapping_b.csv": mappings,
        OUTPUT / "q4_weight_share_b.csv": shares,
    }
