...
\includegraphics[width=.94\linewidth]{figures/q3_algorithm_comparison.pdf}
...
\begin{figure}[H]\centering
\includegraphics[width=.95\linewidth]{figures/q3_pareto_combined.pdf}
...
\begin{figure}[H]\centering
\includegraphics[width=.88\linewidth]{figures/q3_compromise_parallel.pdf}
...
\begin{figure}[H]\centering
\includegraphics[width=.60\linewidth]{figures/q3_final_design_slice.pdf}
