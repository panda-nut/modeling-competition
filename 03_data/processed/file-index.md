...
| `q3/q3_algorithm_metrics.csv` | 23 | 8 | method、run、points、HV、IGD_plus、Spacing、seconds、evaluations | `18cfb0308a07eff9913ea85bbcbf0645f168df7b455e94e56ce780484377e8d2` |
...
| `q5/q5_operation_src_S2A.csv` | 4 | 5 | 扰动因素、Theta_R、P、U、C_op | `cc4b079d7333420c4b5d96dbb425a4f70700b17f699bff35dafe4165120ea63f` |
| `q5/q5_signed_src.csv` | 6 | 5 | 、热目标、P、U、综合评分 | `833f0bd7e4bb22ee68463dd2916b1f90999f232022a212685c18acbe392cd6cc` |
| `q5/q5_src_r2.csv` | 2 | 5 | 模型、热目标、P、U、综合评分 | `9ac373839d016f4d06d9687f641a1f4a83d97d3248663548bfd153443352b0e1` |
...
| `q5/q5_structure_src.csv` | 2 | 5 | 扰动因素、R、P、U、C_str | `10d45060625622253c37def6841da78d28ad88c17927fc5fc941534d9870998a` |
| `validation/q2/q2_encoding_cv.csv` | 4 | 4 | 编码、R_NRMSE、P_NRMSE、U_NRMSE | `f6cc5046eb8d7c6ff305828b28e88672ba35d2752b4319a4df8b890a5568a0c9` |
...
| `validation/q3/q3_model_reoptimization.csv` | 7 | 8 | 模型、a、b、N、R、P、U、评分 | `c9d349ee7713570a17ce27c9d37bb0974927eb948135b8e3a752b12139885db9` |
