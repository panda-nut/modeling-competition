"""问题3综合计算：合并参考集、精确三维HV、连续精化与结果绘图。"""
...
import q3_compare_algorithms as cmp
...
def main():
    ...
    (LOG/"methodology_summary.json").write_text(json.dumps(summary,ensure_ascii=False,indent=2),encoding="utf-8")
