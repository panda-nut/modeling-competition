...
import q4_optimize_preferences as q45  # noqa: E402


OUTPUT = RESULTS / "q3" / "data"
REFERENCE = OUTPUT / "q3_pareto_reference_merged.csv"
REOPTIMIZED = OUTPUT / "validation" / "q3_model_reoptimization.csv"
RESPONSES = ("R", "P", "U")
...
def refine_weighted_front(ridge) -> tuple[pd.DataFrame, pd.DataFrame]:
    ...
    convergence = pd.DataFrame(
        [
            ...
            {
                "method": "reference_plus_weight_refinement",
                "points": int(keep.sum()),
...
def main() -> None:
    ...
    outputs = {
        OUTPUT / "q3_surrogate_front_comparison.csv": front_metrics,
        OUTPUT / "q3_cross_model_candidate_scores.csv": cross_scores,
        OUTPUT / "q3_adaptive_pareto.csv": refined,
        OUTPUT / "q3_grid_refinement_convergence.csv": convergence,
        OUTPUT / "q3_decision_criteria_comparison.csv": decisions,
        OUTPUT / "q3_normalization_sensitivity.csv": normalization,
    }
